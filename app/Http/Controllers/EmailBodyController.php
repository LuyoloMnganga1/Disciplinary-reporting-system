...
class EmailBodyController extends Controller
{
    ...
    public static function useraccount($name,$id, $token)
    {
        $url = url('/set-password/' . $id . '/' . $token);
        $body = ' <tr>
            <td align="center" style="padding:0;">
                    <tr>
                        <td style="padding:36px 30px 42px 30px;">
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p
                                            style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">
                                             You have been add to the HRF Disciplinary Report System, please please click <a href="' . $url . '" target="_blank">here</a> to set your password.
                                        </p>

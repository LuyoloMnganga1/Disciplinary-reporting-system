...
<div class="forms">
    <div class="form-content">
      ...
      <form id="forgot-password-form" action="{{ route('create-password') }}"  method="POST" enctype="multipart/form-data">
        @csrf
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'success') {
                        $("#submit_btn").val('Submit');
                        toastr.success(response.message, 'Password has been captured successfully');
